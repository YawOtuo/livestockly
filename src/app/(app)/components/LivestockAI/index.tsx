  ...
  return (
    <div className="min-h-[60vh] flex flex-col justify-center bg-green2 px-5 lg:px-20 gap-5 py-24">
      <h1 className="text-3xl lg:text-5xl font-semibold">
        Introducing <span className="text-primary font-bold"> Livestockly AI</span>
      </h1>
      <p>
        Livestockly AI: Smarter Livestock Management At the heart of our platform,
        Livestockly AI leverages advanced machine learning and real-time data
        analytics to revolutionize livestock management.
      </p>{" "}
      <p>
        With its ability to monitor herd health, optimize feeding schedules, and
        predict trends, Livestockly AI empowers farmers and ranchers with
        actionable insights to enhance productivity and profitability.{" "}
      </p>
      <p>
        Designed to simplify decision-making, Livestockly AI helps you make
      ...
      <div className="flex flex-col justify-start gap-24 py-24 ">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-20 justify-center ">
          <InfoCard
            ...
            about="Livestockly AI utilizes advanced image recognition technology to monitor livestock health in real-time. By analyzing visual data, the platform can detect signs of illness, injury, or distress, allowing farmers to take immediate action and ensure the well-being of their animals."
            items={[
          ...
          <InfoCard
            ...
            about="Our predictive analytics engine analyzes historical and real-time data to forecast animal growth patterns and potential health risks. This enables farmers to make proactive management decisions that optimize productivity and ensure the health of their livestock."
            items={[
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <InfoCard
            ...
            about="Livestockly AI streamlines the vaccination process by providing intelligent scheduling and automated reminders. This ensures that livestock receive their vaccinations on time, improving herd immunity and overall health."
            items={[
          ...
          <InfoCard
            ...
            about="Our AI-powered chatbots offer round-the-clock assistance, providing expert advice and support for livestock care. Farmers can access reliable information at any time, improving their ability to manage and care for their animals effectively."
            items={[
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <InfoCard
            ...
            about="Livestockly AI employs predictive analytics to forecast potential disease outbreaks within specific regions. By providing timely alerts, farmers can implement preventive measures, safeguarding their livestock and contributing to community health."
            items={[
