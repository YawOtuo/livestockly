    ...
    <>
      {amount ? (
        <motion.div
          ...
          className="flex  border-[1px] md:border-2 border-green2 rounded-2xl lg:rounded-2xl  flex-col   items-center justify-center gap-1 lg:gap-1 py-5  lg:min-w-[200px] aspect-[5/2]
